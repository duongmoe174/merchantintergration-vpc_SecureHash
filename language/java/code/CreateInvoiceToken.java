...
public class CreateInvoiceToken {

    protected void createInvoiceCreateToken(String merchantId, String merchantAccessCode, String merchantHashCode) {
        try {
            ...
            param.put("vpc_CreateToken", true);
    ...
    protected void createInvoiceAndPaymentWithToken(String merchantId, String merchantAccessCode,
            String merchantHashCode, String tokenNum, String tokenExp) {
        try {
            SimpleDateFormat sdfDate = new SimpleDateFormat("yyyyMMddHHmmss");// dd/MM/yyyy
            Date now = new Date();
            String strDate = sdfDate.format(now);
            String vpcMerchTxnRef = "TEST_" + strDate;
            Map<String, Object> param = new HashMap<>();
            param.put("vpc_TokenNum", tokenNum);
            param.put("vpc_TokenExp", tokenExp);
            param.put("vpc_Customer_Id", "test");
            param.put("vpc_Version", "2");
            param.put("vpc_Currency", "VND");
            param.put("vpc_Command", "pay");
