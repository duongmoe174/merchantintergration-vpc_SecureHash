...
namespace CheckHash
{
    class Program
    {
        ...
        {
            MakeInvoiceInstallmentAtMerchantSite();
        }
        ...
        public static void MakeInvoiceAndPaymentWithToken()
        {
            ...
            CreateInvoiceToken.MerchantSendRequetToPaymentWithToken(merchantId, merchantAccessCode, merchantHashCode, tokenNum, tokenExp);
        }
